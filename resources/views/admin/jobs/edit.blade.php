                    ...
                    <div class="card border-0 shadow p-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input {{ ($job->isFeature==1) ? 'checked' : '' }} class="form-check-input" type="checkbox" value="1" id="isFeature" name="isFeature" {{($job->is_featured==1)?'checked':''}}>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-check-inline">
                                    <input {{ ($job->status==1) ? 'checked' : '' }}  class="form-check-input" type="radio" value="1" id="status-active" name="status" {{($job->is_featured==1)?'checked':''}}>
                                    <label class="form-check-label" for="status">
                                    Active
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <input {{ ($job->status==0) ? 'checked' : '' }} class="form-check-input" type="radio" value="0" id="status-block" name="status" {{($job->is_featured==1)?'checked':''}}>
                                    <label class="form-check-label" for="status">
                                    Block
                                    </label>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <textarea name="description" class="textarea" rows="3" placeholder="Description">{{$job->description}}</textarea>
                           <p></p>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <textarea name="benefits" class="textarea" rows="3" placeholder="Benefits">{{$job->benefits}}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <label class="form-label">Responsibility</label>
                                <textarea name="responsibility" class="textarea" rows="3" placeholder="Responsibility">{{$job->responsibility}}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <label class="form-label">Qualifications</label>
                                <textarea name="qualifications" class="textarea" rows="3" placeholder="Qualifications">{{$job->qualifications}}</textarea>
                            </div>
                        </div>
