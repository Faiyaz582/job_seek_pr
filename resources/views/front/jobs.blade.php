                        ...
                        <div class="mb-4">
                            ...
                            @foreach($jobType as $jobType)
                                    <div class="form-check mb-2"> 
                                        <input type="checkbox" name="job_type[]" value="{{$jobType->id}}" id="job-type-{{$jobType->id}}" 
...
<script>
    ...
    if (checkedJobTypes.length > 0) params.push("jobType=" + checkedJobTypes.join(","));
    ...
    console.log(url); // Debugging: Check if URL is correctly formed
