...
Route::group(['prefix' => 'account'], function () {
  ...
  Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/account/my-jobs', [AccountController::class, 'myJobs'])->name('front.account.job.myJobs');
    ...
    Route::post('/account/save-job-alert', [AccountController::class, 'saveJobAlert'])->name('front.account.saveJobAlert');
    Route::post('/applications/{id}/status', [JobsController::class, 'updateApplicationStatus'])->name('applications.updateStatus');
  });
});
